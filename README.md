...
<head>
    ...
    <style>
        ...
        body { 
            ...
            touch-action: none; /* 禁止浏览器默认的缩放和平移 */
...
<body>
    ...
    <script type="module">
        ...
        const CONFIG = {
            ...
            camera: { z: 50 },
            preload: {
                // 设置为 false 关闭本地自动扫描，因为我们现在使用云端图片
                autoScanLocal: false, 
        ...
        async function init() {
            ...
            createDust();
            createSnow();
            loadPredefinedImages(); // 这里的逻辑已更新，支持云图片
            setupPostProcessing();
            setupEvents();
            setupTouchAndClick(); 
        ...
        function loadPredefinedImages() {
            ...
            // 2. 如果开启了本地自动扫描 (CONFIG.preload.autoScanLocal 为 true)
